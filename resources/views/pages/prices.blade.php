...
@section('content')
    ...
    {{-- HERO --}}
    {{-- Increased height to 75vh/85vh to prevent aggressive cropping and show the full scene --}}
    <section class="relative h-[75vh] min-h-[550px] lg:h-[85vh] lg:min-h-[700px] overflow-hidden text-white flex items-end">
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white rounded-3xl overflow-hidden shadow-soft" data-aos="fade-up">
                    <div class="img-zoom aspect-[5/6] overflow-hidden">
                        <img src="/images/greece/Greece_5.jpg" loading="lazy" class="w-full h-full object-cover block" alt="Sailing in Greece">
                    </div>
                    <div class="p-8">
                ...
                <div class="bg-white rounded-3xl overflow-hidden shadow-soft" data-aos="fade-up" data-aos-delay="120">
                    <div class="img-zoom aspect-[5/6] overflow-hidden">
                        <img src="/images/greece/Greece_11.jpg" loading="lazy" class="w-full h-full object-cover block" alt="Cabin on Greek yacht">
                    </div>
                    <div class="p-8">
