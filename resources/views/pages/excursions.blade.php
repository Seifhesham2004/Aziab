        ...
        <div class="max-w-7xl mx-auto">
            ...
            @php
                $excursions = [
                  ...
                  [
                    ...
                    'gallery' => ['turtles-1.jpg','beach-3.jpg','turtles-3.jpg'],
                  ...
                  [
                    ...
                    'gallery' => ['beach-1.jpg','beach-2.jpg','beach-hopping.jpg'],
            ...
            <div class="space-y-12">
                @foreach($excursions as $idx => $e)
                    <div class="bg-white rounded-3xl overflow-hidden shadow-soft card-hover flex flex-col lg:flex-row lg:items-stretch" data-aos="fade-up">

                        {{-- IMAGE SECTION - 3 SCATTERED, NON-OVERLAPPING PHOTOS (LARGER) --}}
                        {{-- Reduced padding slightly to give images more room --}}
                        <div class="lg:w-5/12 p-6 lg:p-8 xl:p-10 flex items-center justify-center bg-slate-50/50 {{ $idx%2 ? 'lg:order-2' : '' }}">
                            ...
                            <div class="flex flex-wrap justify-center gap-4 lg:gap-6 w-full max-w-lg relative">
                                @php
                                    ...
                                    $scatterStyles = [
                                      ...
                                      'rotate-3 -translate-y-2', // Top right
                                      '-rotate-2 translate-y-4'  // Bottom centered
                                    ];
                                @endphp
                                ...
                                @foreach(array_slice($scatterImages, 0, 3) as $imgIndex => $image)
                                    ...
                                    <div class="w-[46%] relative aspect-[4/5] {{ $scatterStyles[$imgIndex] }} transition-all duration-300 hover:rotate-0 hover:scale-110 hover:z-20 z-10 cursor-pointer group">
                                        ...
                                        <div class="absolute inset-0 bg-white p-2 md:p-3 shadow-md rounded-xl group-hover:shadow-xl transition-shadow duration-300">
                                            <img src="/images/excursions/{{ $image }}" loading="lazy" class="w-full h-full object-cover rounded-lg" alt="">
                                        </div>
                                    </div>
                                @endforeach
                            </div>
